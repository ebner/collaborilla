...
public class LDAPAccess {
    ...
    /**
         ...
         * LDAPConnection.DEFAULT_PORT (port 389) or
         * LDAPConnection.DEFAULT_SSL_PORT (port 636).
         */
    ...
    /**
         * CallbackHandler needed for the DIGEST-MD5 bind mechanism. Taken from
         * an example in the Novell JLDAP documentation.
         * 
         * @author Novell
    ...
    /**
         * Checks whether a connection is still alive and attempts to reconnect
    ...
    /**
         * Authenticates after a connection was established. Chooses between
         * several binding methods.
         * 
         * @throws LDAPException
    ...
    /**
         * Authenticate to an LDAP server using a the DIGEST-MD5 SASL mechanism.
         * No certificates required, the data transfer after the authentication
         * is not encrypted.
         * 
         * @throws LDAPException
         */
	...
	try {
	    this.ldapConnection.bind(this.ldapLoginDN, "dn: " + this.ldapLoginDN, mechanisms, null, new BindCallbackHandler(
		    this.ldapPassword));
