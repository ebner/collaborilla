...
public class CollaborillaObject extends LDAPObject implements Cloneable {
    ...
    /**
         ...
         * described by the URI parameter does not exist yet it will be created
         * by the constructor.
         * 
         * @param dir
         *                LDAP connection
         * @param serverDN
         *                Server Distinctive Name (DN).&nbsp;Example:
         *                "dc=test,dc=com".
         * @param uri
         *                URI
         * @param create
         *                Create the LDAP entry of the given DN should be
    ...
    /**
         * Updates the Base DN for accessing the right LDAP entry. Takes the
         * Server DN, URI and the revision into consideration for creating a
         * Base DN.
         */
    ...
    /**
         * Sets the number of the revision. After setting the revision the Base
         * DN will be rebuilt and all operations will be performed at the
         * revision with the number of the parameter.
         * 
         * @see #updateBaseDN()
         * @param rev
         *                Revision number.&nbsp;Should be 0 to return to the
         *                most recent LDAP entry.
         */
    ...
    /**
         ...
         * 
         * @return Info of the current revision, currently RDF info.&nbsp;Will
         *         be probably changed in future.
         * @throws LDAPException
         */
    ...
    /**
         * Sets the current revision to the most recent entry and copies all
         * data into a new revision. Performs a setRevision(0).
         * 
         * @throws LDAPException
         */
    ...
    /**
         * Reads all URLs of the entry and returns a String array. If the
         * Location attribute of this entry does not exist it will try to
         * construct Locations by querying the entries of the parent URIs.
         * 
         * @return Array of URLs
         * @throws LDAPException
         */
	...
	if (result == null) {
	    /*
                 ...
                 * NO_SUCH_ATTRIBUTE 2 one level up, increase level counter 3
                 * get location 4 if NO_SUCH_ATTRIBUTE or NO_SUCH_OBJECT -> 1
                 * (one level up) 5 if we get a location: 1 get last part of URI
                 * depending on the level counter 2 loop through the returned
                 * URL and append 5.1 6 return result
                 */
