...
public class LDAPObject implements Cloneable {
    ...
    public Date getTimestampCreated(String dn) throws LDAPException {
        ...
        return LDAPStringHelper.parseTimestamp(this.readAttribute(dn,
                "createTimeStamp")[0]);
    }
    ...
    public int childCount(String dn, int searchScope) throws LDAPException {
        ...
        /* perform the search */
        LDAPSearchResults searchResults = this.ldapAccess.ldapConnection
                .search(dn, searchScope, searchFilter, null, true);
    ...
    public void moveEntry(String oldDN, String newDN) throws LDAPException {
        ...
        this.ldapAccess.checkConnection();
        this.ldapAccess.ldapConnection.rename(oldDN, entryAttributeType + "="
                + LDAPStringHelper.dnToEntryID(newDN), LDAPStringHelper
    ...
    public void copyEntry(String sourceDN, String destDN) throws LDAPException {
        ...
        LDAPEntry sourceLdapEntry = this.ldapAccess.ldapConnection
                .read(sourceDN);
        ...
        /* add new CN */
        attributeSet.add(new LDAPAttribute(entryAttributeType, LDAPStringHelper
                .dnToEntryID(destDN)));
     ...
     * @throws LDAPException
     */
    public void createEntryWithContainer(String containerPath,
            String entryObjectClass, String entryIDField, String entryIDValue)
            throws LDAPException {
        this.createEntryWithContainer(containerPath, "organizationalUnit",
                "ou", entryObjectClass, entryIDField, entryIDValue);
    }
     ...
     */
    public void createEntryWithContainer(String containerPath,
            String pathObjectClass, String pathIDField,
            String entryObjectClass, String entryIDField, String entryIDValue)
            throws LDAPException {
        String parent = null;
        ...
        if (!entryExists(containerPath)) {
            ...
            this.createEntryWithContainer(parent, pathObjectClass, pathIDField,
                    pathObjectClass, pathIDField, LDAPStringHelper
                            .dnToEntryID(containerPath));
        }

        this.createEntry(containerPath, entryObjectClass, entryIDField,
                entryIDValue);
    }
     ...
     * @throws LDAPException
     */
    public void createEntry(String containerPath, String entryObjectClass,
     ...
     * @throws LDAPException
     */
    public String exportEntryLdif(String dn, boolean encodeBase64)
            throws LDAPException {
        /* build the whole DN */
                ...
                while (allValues.hasMoreElements()) {
                    ...
                    if (encodeBase64) {
                        ...
                        if (!Base64.isLDIFSafe(attributeValue)) {
                            attributeValue = Base64.encode(attributeValue
                                    .getBytes());
                        }
                    }
     ...
     * @throws LDAPException
     */
    public boolean attributeExists(String dn, String attribute)
            throws LDAPException {
     ...
     * @throws LDAPException
     */
    public String[] readAttribute(String dn, String attribute)
            throws LDAPException {
        ...
        /* read the whole entry */
        LDAPEntry ldapEntry = this.ldapAccess.ldapConnection
                .read(dn, attrArray);
     ...
     * @throws LDAPException
     */
    public void addAttribute(String dn, String attrType, String attrValue)
            throws LDAPException {
     ...
     * @throws LDAPException
     */
    public void removeAttribute(String attrType, String attrValue)
            throws LDAPException {
     ...
     * @throws LDAPException
     */
    public void removeAttribute(String dn, String attrType, String attrValue)
            throws LDAPException {
        ...
        /* build a new modification */
        LDAPModification modification = new LDAPModification(
                LDAPModification.DELETE, attribute);
    ...
    public void removeAllAttributes(String dn) throws LDAPException {
        ...
        while (allAttributes.hasNext()) {
            ...
            LDAPModification modification = new LDAPModification(
                    LDAPModification.DELETE, attrToRemove);
     ...
     * @throws LDAPException
     */
    public void modifyAttribute(String attrType, String oldValue,
            String newValue) throws LDAPException {
     ...
     * @throws LDAPException
     */
    public void modifyAttribute(String dn, String attrType, String oldValue,
            String newValue) throws LDAPException {
     ...
     * @throws LDAPException
     */
    public void resetAttribute(String attrType, String newValue)
            throws LDAPException {
     ...
     * @throws LDAPException
     */
    public void resetAttribute(String dn, String attrType, String newValue)
            throws LDAPException {
        this.ldapAccess.checkConnection();
     ...
     * @throws LDAPException
     */
    public void copyAttributes(String sourceDN, String destDN)
            throws LDAPException {
        /* container path (parent/superior) of the destination DN has to exist */
