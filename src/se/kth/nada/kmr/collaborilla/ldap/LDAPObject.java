...
public class LDAPObject implements Cloneable {
    ...
    /**
         ...
         *                The type of the identifier of the Relative Distinctive
         *                Names (RDN)
         */
    ...
    /**
         ...
         * 
         * @param searchScope
         *                Defines how deep the search should go.&nbsp; Must be a
         *                value of LDAPConnection.SCOPE_*.
         * 
	...
	/* perform the search */
	LDAPSearchResults searchResults = this.ldapAccess.ldapConnection.search(dn, searchScope, searchFilter, null, true);
    ...
    /**
         * Removes the current entry from the tree. Does only work on leaf
         * entries.
         * 
         * @throws LDAPException
         */
    ...
    /**
         * Removes a specific entry from the tree. Does only work on leaf
         * entries.
         * 
         * @param dn
         *                Distinctive Name (DN)
    ...
    /**
         * Moves the current entry to a new location in the tree. Does only work
         * on leaf entries and the parent DN (container) of the destination has
         * to exist.
         * 
         * @param newDN
    ...
    /**
         * Moves a specific entry to a new location in the tree. Does only work
         * on leaf entries and the parent DN (container) of the destination has
         * to exist.
         * 
         * @param oldDN
	...
	this.ldapAccess.checkConnection();
	this.ldapAccess.ldapConnection.rename(oldDN, entryAttributeType + "=" + LDAPStringHelper.dnToEntryID(newDN), LDAPStringHelper
		.dnToParentDN(newDN), true);
    }
    ...
    /**
         * Copies the current entry to another location in the tree. The
         * Container path (parent/superior) of the destination DN has to exist.
         * 
         * @param destDN
         *                Distinctive Name (DN) to which the entry should be
         *                copied to
         * @throws LDAPException
         */
    ...
    /**
         * Copies a specific entry to another location in the tree. The
         * Container path (parent/superior) of the destination DN has to exist.
         * 
         * @param sourceDN
         *                Distinctive Name (DN) of the source
    ...
    /**
         ...
         * Container path (parent/superior) of the destination DN does not
         * exist, it will be created. The automatically created entries to
         * create a container path will be of the ObjectClass
         * "organizationaUnit".
         * 
         * @param containerPath
         ...
         * @throws LDAPException
         */
    public void createEntryWithContainer(String containerPath, String entryObjectClass, String entryIDField, String entryIDValue)
	    throws LDAPException {
	this.createEntryWithContainer(containerPath, "organizationalUnit", "ou", entryObjectClass, entryIDField, entryIDValue);
    }
    ...
    /**
         ...
         *                ObjectClass of the (created if they don't exist yet)
         *                parent entries
         * @param pathIDField
         *                Identifying field of the parent entries (Example: "ou"
         ...
         * @throws LDAPException
         */
    public void createEntryWithContainer(String containerPath, String pathObjectClass, String pathIDField, String entryObjectClass,
	    String entryIDField, String entryIDValue) throws LDAPException {
	String parent = null;
	...
	if (!entryExists(containerPath)) {
	    ...
	    this.createEntryWithContainer(parent, pathObjectClass, pathIDField, pathObjectClass, pathIDField, LDAPStringHelper
		    .dnToEntryID(containerPath));
	}
    ...
    /**
         * Creates a new entry at the given destination in the tree. The
         * container path has to exist.
         * 
         * @param containerPath
         *                Parent DN of the new entry
         * @param entryObjectClass
         ...
         * @throws LDAPException
         */
    public void createEntry(String containerPath, String entryObjectClass, String entryIDField, String entryIDValue) throws LDAPException {
    ...
    /**
         ...
         * @param attribute
         *                Name of the attribute
         * @return String array with the attribute values or null if the
    ...
    /**
         ...
         *                Type of attribute
         * @param attrValue
         *                Value of the attribute.&nbsp;If the value is null, all
         *                values of the attribute will be removed.
         * @throws LDAPException
         */
    ...
    /**
         * Removes all attributes - except the Relativ Distinctive Name (RDN) -
	...
	while (allAttributes.hasNext()) {
	    ...
	    if (attributeName.equalsIgnoreCase(this.entryAttributeType) || attributeName.equalsIgnoreCase("objectclass")) {
		continue;
	    }
    ...
    /**
         * Copies all attributes - without the Relative Distinctive Name (RDN) -
         * to an existing entry. The container path of the destination DN has to
         * exist.
         * 
         * @param sourceDN
         *                Then entry from which the attributes should be copied
         *                from
         * @param destDN
         *                The destination to which the attributes should be
         *                copied to
         * @throws LDAPException
         */
