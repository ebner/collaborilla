...
public final class CollaborillaServiceClient implements CollaborillaAccessible {
	...
	if (resp != null) {
	    if ((resp.statusCode != CollaborillaServiceStatus.SC_OK) && (resp.statusCode != CollaborillaServiceStatus.SC_CLIENT_DISCONNECT)) {
	...
	if (create) {
	    this.sendRequest(CollaborillaServiceCommands.CMD_URI + " " + CollaborillaServiceCommands.CMD_URI_NEW + " " + uri);
	} else {
	...
	this.sendRequest(CollaborillaServiceCommands.CMD_SET + " " + CollaborillaServiceCommands.ATTR_REVISION + " " + rev);
    }
	...
	this.sendRequest(CollaborillaServiceCommands.CMD_RESTORE + " " + CollaborillaServiceCommands.ATTR_REVISION + " " + rev);
    }
	...
	this.sendRequest(CollaborillaServiceCommands.CMD_ADD + " " + CollaborillaServiceCommands.ATTR_LOCATION + " " + url);
    }
	...
	this.sendRequest(CollaborillaServiceCommands.CMD_MOD + " " + CollaborillaServiceCommands.ATTR_LOCATION + " " + oldUrl + " "
		+ newUrl);
    }
	...
	this.sendRequest(CollaborillaServiceCommands.CMD_DEL + " " + CollaborillaServiceCommands.ATTR_LOCATION + " " + url);
    }
	...
	this.sendRequest(CollaborillaServiceCommands.CMD_ADD + " " + CollaborillaServiceCommands.ATTR_URI_ORIG + " " + uri);
    }
	...
	this.sendRequest(CollaborillaServiceCommands.CMD_MOD + " " + CollaborillaServiceCommands.ATTR_URI_ORIG + " " + oldUri + " "
		+ newUri);
    }
	...
	this.sendRequest(CollaborillaServiceCommands.CMD_DEL + " " + CollaborillaServiceCommands.ATTR_URI_ORIG + " " + uri);
    }
	...
	this.sendRequest(CollaborillaServiceCommands.CMD_ADD + " " + CollaborillaServiceCommands.ATTR_URI_OTHER + " " + uri);
    }
	...
	this.sendRequest(CollaborillaServiceCommands.CMD_MOD + " " + CollaborillaServiceCommands.ATTR_URI_OTHER + " " + oldUri + " "
		+ newUri);
    }
	...
	this.sendRequest(CollaborillaServiceCommands.CMD_DEL + " " + CollaborillaServiceCommands.ATTR_URI_OTHER + " " + uri);
    }
	...
	this.sendRequest(CollaborillaServiceCommands.CMD_DEL + " " + CollaborillaServiceCommands.ATTR_CONTAINER_RDFINFO);
    }
