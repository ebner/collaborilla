...
public class CollaborillaServiceProtocol {
    ...
    /**
         * Takes the received string from the client, parses it and delegates
         * the command and its parameters to the responsible methods.
         * 
         * @param request
	...
	if (command[0].equalsIgnoreCase(CollaborillaServiceCommands.CMD_SET)) {
	    /*
                 * we need more than just word, so we concat again ...not the
                 * most intelligent solution though...
                 */
